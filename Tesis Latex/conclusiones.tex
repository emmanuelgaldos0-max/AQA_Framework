...
\textbf{Cuarto}, la comparación con el estado del arte sitúa el \textit{pipeline} propuesto por encima de todos los métodos representativos del campo en AQA-7 reportados con \textit{backbones} \ac{I3D} (USDL, GAKD, CoRe, TSA-Net, HGCN), con la variante X3D-M alcanzando $0.9211$ \ac{SRCC} usando $\sim 8.5\%$ de los \ac{FLOPs} del \ac{I3D}. Adicionalmente, X3D-M con la misma receta supera al \textit{Teacher} \ac{I3D} en los tres datasets evaluados: $0.9211$ vs $0.9052$ en AQA-7, $0.8937$ vs $0.8869$ en MTL-AQA, y $0.8682$ vs $0.8364$ en JIGSAWS. En MTL-AQA los métodos SOTA con componentes específicos para clavados aún superan al \textit{pipeline} liviano, lo que delimita el margen de mejora restante.
